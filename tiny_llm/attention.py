"""L4 stages 2 and 3 - one causal attention head, written with tensors.

This is the module later milestones import. attention_plain.py holds stage 1: the five steps as plain Python loops, every number
...
from attention_plain import (D_HEAD, SEED, T, attention_plain, build_matrix,
                             example_input)
...
if __name__ == "__main__":
    ...
    print("=" * 74)
    print()
    print("  attention_plain.py spends about forty lines of loops on this. Here")
    print("  it is with the loops handed to the library:")
    print()
